...
<div class="sidebar-nav">
    <ul>
        ...
        <li><a href="#" data-target=".project-menu" class="nav-header" data-toggle="collapse"><i class="fa fa-fw fa-legal"></i> Project and Course<i class="fa fa-collapse"></i></a></li>
        <li><ul class="project-menu nav nav-list collapse in">
                ...
                <li class="active"><a href="course-list.php"><span class="fa fa-caret-right"></span> Course List</a></li>
